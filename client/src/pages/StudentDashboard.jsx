...
// Add fetchResumeScore function
const fetchResumeScore = async () => {
  const studentId = localStorage.getItem('studentId')
  try {
    const res = await axios.get(`http://localhost:8000/api/resume/score?student_id=${studentId}`)
        ...
        <main className="sd-main">
          ...
          <div className="sd-profile-card">
            ...
            <div className="sd-resume-section">
              ...
              <div className="sd-resume-bar-bg" style={{ position: "relative", marginTop: "20px" }}>
                <span className="sd-resume-pct">{resumeScore ? `${resumeScore}%` : 'N/A'}</span>
                <div className="sd-resume-bar-fill" style={{ width: resumeScore ? `${resumeScore}%` : '0%' }}/>
              </div>
              {student.resume ? (
          ...
          <div className="sd-stats-row">
            {[
              ...
              { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>, value: resumeScore ? `${resumeScore}/100` : "—", label: "Resume Score" },
